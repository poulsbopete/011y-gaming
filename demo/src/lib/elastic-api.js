...
export const AETHER_LAUNCH_OPS_DASHBOARD_ID = 'aether-launch-ops';
...
export const LAUNCH_NIGHT_WORKFLOW_ID = 'aether-launch-night';
...
export function kibanaSecurityUrl(section = 'alerts') {
  ...
  const paths = {
    ...
    // Attack Discovery moved under Detections → Views → Attacks
    attackDiscovery: '/app/security/attacks',
    attacks: '/app/security/attacks',
  };
