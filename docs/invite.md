...
2. Open **Horizon — Dashboard sprawl** — inventory which boards still query which indexes; schema-drift so a relabel does not silently blank matchmaking widgets
