...
BOARDS: list[tuple[str, str, str, list[dict]]] = [
    (
        ...
        [
            ...
            panel_stat("Avg latency", "avg(http_request_duration_seconds)", 12, 0, unit="s"),
    ...
    (
        ...
        [
            ...
            panel_stat("Avg connect", 'avg(http_request_duration_seconds{service="session-gateway"})', 18, 0, unit="s"),
    ...
    (
        ...
        [
            ...
            panel_stat("Auth avg latency", 'avg(http_request_duration_seconds{service="auth"})', 18, 0, unit="s"),
    ...
    (
        ...
        [
            ...
            panel_stat("Checkout avg", "avg(aether_store_checkout_duration_seconds)", 6, 0, unit="s"),
    ...
    (
        ...
        [
            ...
            panel_ts("Party service avg latency", 'avg(http_request_duration_seconds{service="party"})', 0, 6, w=24, legend="avg"),
        ],
    ),
    (
        "10-presence",
    ...
    (
        ...
        [
            ...
            panel_stat("Grant avg", "avg(aether_entitlement_grant_duration_seconds)", 12, 0, unit="s"),
    ...
    (
        ...
        [
            ...
            panel_stat("Edge avg latency", 'avg(http_request_duration_seconds{service="cdn-edge"})', 12, 0, unit="s"),
    ...
    (
        ...
        [
            panel_stat("DB avg", 'avg(aether_dependency_duration_seconds{dependency="postgres"})', 0, 0, unit="s"),
            panel_stat("Redis avg", 'avg(aether_dependency_duration_seconds{dependency="redis"})', 6, 0, unit="s"),
            panel_stat("Kafka lag", "sum(aether_kafka_consumer_lag)", 12, 0),
            panel_ts("Dependency latency", "avg(aether_dependency_duration_seconds) by (dependency)", 0, 6, w=24, legend="{{dependency}}"),
        ],
    ),
]
